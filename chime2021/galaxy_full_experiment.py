...
Modified version of galaxy_full_experiment.py that is specialized to DESI.
"""
import os
import numpy as np
import pylab as P
...
survey_name = 'gDESI_combined'
expt = e.DESI_combined
e.load_expt(expt)
zmin = expt['zmin']
zmax = expt['zmax']

# Create output directory if it doesn't exist
if not os.path.exists("forecast_outputs/"):
    os.makedirs("forecast_outputs/")
...
# Define power spectrum k bins (used for output)
...
if myid == 0:
    print("Total no. of galaxies: %3.3e" % np.sum(Ngal_tot))
